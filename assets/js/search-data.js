...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-paper-accepted-in-tmlr",
          title: 'Paper accepted in TMLR',
          description: "",
          section: "News",},{id: "news-release-ts-icl-a-continuous-probabilistic-time-series-foundation-model-that-unifies-forecasting-and-imputation-in-a-single-zero-shot-architecture-check-the-repo-here",
          title: 'Release: TS-ICL, a continuous probabilistic Time Series Foundation Model that unifies forecasting and...',
          description: "",
